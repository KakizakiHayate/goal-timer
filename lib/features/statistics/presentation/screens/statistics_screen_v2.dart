...
import '../../../../core/widgets/metric_card_v2.dart';
import '../../../../core/widgets/chart_card_v2.dart';
import '../../../../core/widgets/achievement_badge_v2.dart';
import '../viewmodels/statistics_view_model.dart';

/// 改善された統計画面
/// データビジュアライゼーションと達成感を重視
class StatisticsScreenV2 extends ConsumerStatefulWidget {
  const StatisticsScreenV2({super.key});

  @override
  ConsumerState<StatisticsScreenV2> createState() => _StatisticsScreenV2State();
}

class _StatisticsScreenV2State extends ConsumerState<StatisticsScreenV2>
