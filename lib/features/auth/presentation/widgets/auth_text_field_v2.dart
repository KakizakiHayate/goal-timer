...
/// 改善された認証フォーム用テキストフィールド
/// フォーカス状態の視覚的フィードバックを強化
class AuthTextFieldV2 extends StatefulWidget {
  ...
  @override
  State<AuthTextFieldV2> createState() => _AuthTextFieldV2State();
}

class _AuthTextFieldV2State extends State<AuthTextFieldV2>
