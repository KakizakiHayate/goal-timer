...
class TimerScreenV2 extends ConsumerStatefulWidget {
  final String goalId;

  const TimerScreenV2({super.key, required this.goalId});

  @override
  ConsumerState<TimerScreenV2> createState() => _TimerScreenV2State();
}

class _TimerScreenV2State extends ConsumerState<TimerScreenV2>
