...
import 'package:goal_timer/backup/core/data/datasources/supabase/supabase_datasource.dart';
...
import 'package:goal_timer/backup/core/data/repositories/supabase/goals/goals_repository_impl.dart';
...
// 新しく追加したクラスのインポート
import 'package:goal_timer/backup/core/data/datasources/local/users/local_users_datasource.dart';
import 'package:goal_timer/backup/core/data/datasources/supabase/users/supabase_users_datasource.dart';
import 'package:goal_timer/backup/core/data/repositories/hybrid/users/hybrid_users_repository.dart';
import 'package:goal_timer/backup/core/data/datasources/local/daily_study_logs/local_daily_study_logs_datasource.dart';
import 'package:goal_timer/backup/core/data/datasources/supabase/daily_study_logs/supabase_daily_study_logs_datasource.dart';
import 'package:goal_timer/backup/core/data/repositories/hybrid/daily_study_logs/hybrid_daily_study_logs_repository.dart';

// UseCaseのインポート
import 'package:goal_timer/backup/core/usecases/goals/fetch_goals_usecase.dart';
import 'package:goal_timer/backup/core/usecases/goals/sync_goals_usecase.dart';
import 'package:goal_timer/backup/core/usecases/goals/create_goal_usecase.dart';
import 'package:goal_timer/backup/core/usecases/goals/update_goal_usecase.dart';
import 'package:goal_timer/backup/core/usecases/goals/delete_goal_usecase.dart';

// SyncCheckerのインポート
import 'package:goal_timer/backup/core/services/sync_checker.dart';

// StudyStatisticsServiceのインポート
import 'package:goal_timer/backup/core/services/study_statistics_service.dart';

// GlobalStatisticsNotifierのインポート
import 'package:goal_timer/backup/core/provider/global_statistics_notifier.dart';
import 'package:goal_timer/backup/core/models/study_statistics.dart';

// 認証関連のインポートを追加
import 'package:goal_timer/backup/features/auth/domain/entities/app_user.dart';
import 'package:goal_timer/backup/features/auth/domain/entities/auth_state.dart'
    as app_auth;
import 'package:goal_timer/backup/features/auth/provider/auth_provider.dart';
