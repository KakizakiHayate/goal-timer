...
_$CustomerInfoImpl _$$CustomerInfoImplFromJson(
  Map<String, dynamic> json,
) => _$CustomerInfoImpl(
  originalAppUserId: json['originalAppUserId'] as String,
  entitlements: (json['entitlements'] as Map<String, dynamic>).map(
    (k, e) => MapEntry(k, EntitlementInfo.fromJson(e as Map<String, dynamic>)),
  ),
  originalPurchaseDate:
      json['originalPurchaseDate'] == null
          ? null
  ...
  latestExpirationDate:
      json['latestExpirationDate'] == null
          ? null
...
Map<String, dynamic> _$$CustomerInfoImplToJson(_$CustomerInfoImpl instance) =>
    <String, dynamic>{
      ...
      'allPurchaseDates': instance.allPurchaseDates.map(
        (k, e) => MapEntry(k, e?.toIso8601String()),
      ),
      'allExpirationDates': instance.allExpirationDates.map(
        (k, e) => MapEntry(k, e?.toIso8601String()),
      ),
    };
