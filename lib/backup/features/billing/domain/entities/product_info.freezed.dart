...
mixin _$ProductInfo {
  ...
  String? get introductoryPeriod => throw _privateConstructorUsedError;
...
class _$ProductInfoCopyWithImpl<$Res, $Val extends ProductInfo>
  ...
  $Res call({
    ...
    Object? introductoryPeriod = freezed,
...
class _$ProductInfoImpl implements _ProductInfo {
  ...
  @override
  String toString() {
    return 'ProductInfo(identifier: $identifier, title: $title, description: $description, price: $price, currencyCode: $currencyCode, priceAmount: $priceAmount, introductoryPrice: $introductoryPrice, introductoryPeriod: $introductoryPeriod, subscriptionPeriod: $subscriptionPeriod, isAvailable: $isAvailable)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.introductoryPeriod, introductoryPeriod) ||
                other.introductoryPeriod == introductoryPeriod) &&
...
mixin _$EntitlementInfo {
  ...
  DateTime? get latestPurchaseDate => throw _privateConstructorUsedError;
  DateTime? get originalPurchaseDate => throw _privateConstructorUsedError;
...
class _$EntitlementInfoImpl implements _EntitlementInfo {
  ...
  @override
  String toString() {
    return 'EntitlementInfo(identifier: $identifier, isActive: $isActive, expirationDate: $expirationDate, latestPurchaseDate: $latestPurchaseDate, originalPurchaseDate: $originalPurchaseDate, productIdentifier: $productIdentifier, willRenew: $willRenew)';
  }
...
abstract class _EntitlementInfo implements EntitlementInfo {
  ...
  @override
  DateTime? get originalPurchaseDate;
  @override
...
mixin _$CustomerInfo {
  ...
  Map<String, EntitlementInfo> get entitlements =>
      throw _privateConstructorUsedError;
  DateTime? get originalPurchaseDate => throw _privateConstructorUsedError;
  DateTime? get latestExpirationDate => throw _privateConstructorUsedError;
  Map<String, DateTime?> get allPurchaseDates =>
      throw _privateConstructorUsedError;
  Map<String, DateTime?> get allExpirationDates =>
      throw _privateConstructorUsedError;
...
class _$CustomerInfoImpl extends _CustomerInfo {
  ...
  final Map<String, EntitlementInfo> _entitlements;
  @override
  Map<String, EntitlementInfo> get entitlements {
  ...
  final Map<String, DateTime?> _allPurchaseDates;
  @override
  @JsonKey()
  Map<String, DateTime?> get allPurchaseDates {
  ...
  final Map<String, DateTime?> _allExpirationDates;
  @override
  @JsonKey()
  Map<String, DateTime?> get allExpirationDates {
  ...
  @override
  String toString() {
    return 'CustomerInfo(originalAppUserId: $originalAppUserId, entitlements: $entitlements, originalPurchaseDate: $originalPurchaseDate, latestExpirationDate: $latestExpirationDate, allPurchaseDates: $allPurchaseDates, allExpirationDates: $allExpirationDates)';
  }
