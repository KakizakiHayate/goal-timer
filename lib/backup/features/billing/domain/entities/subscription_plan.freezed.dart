...
mixin _$SubscriptionPlan {
  ...
  Duration? get trialDuration => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      ...
      hasFreeTrial: null == hasFreeTrial
          ...
          : hasFreeTrial // ignore: cast_nullable_to_non_nullable
              as bool,
      trialDuration: freezed == trialDuration
          ? _value.trialDuration
          : trialDuration // ignore: cast_nullable_to_non_nullable
              as Duration?,
...
class _$SubscriptionPlanImpl implements _SubscriptionPlan {
  ...
  @override
  String toString() {
    return 'SubscriptionPlan(id: $id, title: $title, price: $price, period: $period, duration: $duration, hasFreeTrial: $hasFreeTrial, trialDuration: $trialDuration, introPrice: $introPrice, discount: $discount, features: $features, isPopular: $isPopular)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.trialDuration, trialDuration) ||
                other.trialDuration == trialDuration) &&
...
abstract class _SubscriptionPlan implements SubscriptionPlan {
  const factory _SubscriptionPlan(
      ...
      required final bool hasFreeTrial,
      required final Duration? trialDuration,
      required final String? introPrice,
      required final String? discount,
      required final List<String> features,
      final bool isPopular}) = _$SubscriptionPlanImpl;
